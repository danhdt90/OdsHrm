                           ...
                           <div className="p-6">
                            <form onSubmit={handleSubmit} method='POST' encType="multipart/form-data">
                                ...
                                <div className="my-6">
                                    ...
                                    <input value={userRequest.request_name} required="" type="text" name="request_name" id="" placeholder="" className="block w-full p-2 border border-gray-300 rounded-md" />
                                </div>
                                {
                                   inputDetailRequests.map((input, index) =>
                                        input.input_type === 'select' ? (
                                            ...
                                            <div className="my-6" key={index}>
                                                ...
                                                <select value={input.input_value} required={input.required} name={input.input_name} id="" className="block w-full p-2 border border-gray-300 rounded-md">
                                        ...
                                        */
                                         input.input_type === 'textarea' ? (
                                            <div className="my-6" key={index}>
                                            <label htmlFor="">{input.input_description}</label>
                                            <textarea required={input.required} name={input.input_name} id="" cols="30" rows="10" placeholder={input.placeholder} className="block w-full p-2 border border-gray-300 rounded-md">{input.input_value}</textarea>
                                            </div>
                                        ) :
                                        /** Select người duyệt */
                                        (input.input_type === 'follower'||input.input_type === 'approver') ? (
                                            <div className="my-6" key={index}>
                                                ...
                                                {auth.user.direct_manager && (
                                                    <div className="my-6" key={index}>
                                                        <input value={input.input_value} type='hidden' name="follower"value={auth.user.direct_manager} />
                                                        <input
                                                            type="text"
                                        ...
                                        (
                                            <div className="my-6" key={index}>
                                                <label htmlFor={input.input_name}>{input.input_description}</label>
                                                <input value={input.input_value} required={input.required} type={input.input_type} name={input.input_name} id={input.input_name} placeholder={input.placeholder} className="block w-full p-2 border border-gray-300 rounded-md" />
                                            </div>
                                        )
                                    )
                                }
