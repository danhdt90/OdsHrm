                            ...
                            <div className="flex items-center w-full my-6 -ml-1.5">
                                <div className="w-1/12 z-10 mr-2">
                                        {approver.user_id === "qltt" ?
                                            ...
                                            statusApprover.status === 2 ? <div className="w-3.5 h-3.5 bg-red-600 rounded-full">
                                            </div> :
                                        ...
                                        approver.user_id === "hr" ?
                                            ...
                                            statusApprover.hr_status === 2 ? <div className="w-3.5 h-3.5 bg-red-600 rounded-full">
                                            </div> :
                                            <div className="w-3.5 h-3.5 bg-yellow-600 rounded-full">
                                            </div> :
                                        approver.user_id === "ceo" ?
                                            ...
                                            statusApprover.fully_accept === 2 ? <div className="w-3.5 h-3.5 bg-red-600 rounded-full">
                                            </div> :
                                            <div className="w-3.5 h-3.5 bg-yellow-600 rounded-full">
                                            </div> :""
                                            }
